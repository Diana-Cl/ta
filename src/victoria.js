...
let proxyIP = '';
let sub = '';
let subConverter = 'SUBAPI.fxxk.dedyn.io';//Clash subscription conversion backend, currently using CM's subscription conversion function. Comes with false node information to prevent leakage
